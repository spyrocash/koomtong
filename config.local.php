...
$config['db_name'] = 'koomtong_com';
$config['db_user'] = 'koomtong_com';
$config['db_password'] = 'jokerboso';
...
$config['http_host'] = 'www.koomtong.com';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'www.koomtong.com';
$config['https_path'] = '';
